...
$table= "Candidate"; /* Name of the table, can be freely chosen */
...
$Zip = mysqli_real_escape_string($dbc,$_GET['ZipCodes']);
...
if ($numberOfRows > 0) {
    ...
    $values = mysqli_query($dbc, "SELECT * FROM $table WHERE ElectionId='$ElectionId' and ZipCodes LIKE '%$Zip%'");
